...
MUSL_DEFAULT_VERSION=1.1.16
MUSL_GIT_VERSION=8fe1f2d79b275b7f7fb0d41c99e379357df63cd9
...
gccprereqs() {
    ...
    then
        fetchextract https://ftp.gnu.org/pub/gnu/gmp/ gmp-$GMP_VERSION .tar.bz2
